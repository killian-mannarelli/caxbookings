    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.roomequipment')),
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.rooms')),
            ],
            options={
